...
Database WorldDatabase;                                 ///< Accessor to the world database
Database CharacterDatabase;                             ///< Accessor to the character database
Database loginDatabase;                                 ///< Accessor to the realm/login database
