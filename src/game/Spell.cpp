...
SpellCastResult Spell::CheckCast(bool strict)
{
    ...
    // Aura 262
    Unit::AuraList const& ignoreReqAuras = m_caster->GetAurasByType(SPELL_AURA_IGNORE_UNIT_STATE);
                ...
                {
                    {
                       ...
                       else if(summon_prop->Group == SUMMON_PROP_GROUP_PETS)
                        {
